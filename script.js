...
{
    if(scale.value != 0 && resX.value != 0 && resY.value != 0)
    {
        ...
        ctx.fillRect(0, 0, scale.value, scale.value);

        //Get image data
        imgData = ctx.getImageData(0, 0, scale.value, scale.value);
    ...
    else
    {
        ...
        alert("Scale and resolution can't equal 0");
    }
}
